    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak>
        ...
        <div class="hidden w-full place-items-center lg:grid">
            <div class="w-full max-w-lg p-6">
                ...
                <img class="w-full" x-show="$store.global.isDarkModeEnabled"
                    src="assets/images/illustrations/dashboard-check-dark.svg" alt="image" />
            </div>
        </div>
        <main class="flex w-full flex-col items-center bg-white dark:bg-navy-700 lg:max-w-md">
            <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
                ...
                <!-- Sigin part where user logs in -->
                <?php echo form_open('Signin',['name'=>'userregistration','class'=>'form-control','autocomplete'=>'off']);?>
                <div class="mt-16">
				...
				<?php } ?>
                    ...
                    <?php echo form_submit(['name'=>'insert','value'=>'Sign In','class'=>'btn mt-10 h-10 w-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90']);?>
                    ...
                    <div class="mt-4 text-center text-xs+">
                        <p class="line-clamp-1">
                            ...
                            href="<?php echo site_url('Signup');?>">Create account</a>
                        </p>
                    </div>
